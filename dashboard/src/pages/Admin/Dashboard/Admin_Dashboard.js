...
const Admin = () => {
    ...
    useEffect(() => {
        // Gọi tất cả các action chỉ trong một useEffect
        dispatch(getUserQuantity());
        dispatch(getCalculateRevenue());
        dispatch(getAvailableProduct());
        dispatch(getCountProductSales());
        dispatch(getOrderQuantity())
        dispatch(getBrandSold())
    }, [dispatch]); // Thêm dispatch làm dependency
    const navigate = useNavigate();
    useEffect(() => {
        const accToken = Cookies.get("refreshToken");
        if(!accToken) {
    ...
    return (
        <>
            ...
            <div className="lg:ml-72 mt-16 md:mt-0">
                <div className="px-8 border-2 border-gray-200 border-dashed rounded-2xl dark:border-gray-700">
                    <div className="grid md:grid-cols-3 grid-cols-1 gap-4 mb-4">
                        ...
                        <div
                            ...
                            <div className="mx-5">
                                <h4 className="text-2xl font-semibold text-gray-500">{quantityUsers}</h4>
                                <div className="text-gray-500 font-semibold">Người dùng</div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div className="mx-5">
                                <h4 className="text-2xl font-semibold  text-gray-700">{quantityOrders.totalQuantityOrderSuccess}/{quantityOrders.totalQuantityOrder}</h4>
                                <div className="text-gray-500 font-semibold">Đơn hàng hoàn thành</div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div className="mx-5">
                                <h4 className="text-2xl font-semibold text-gray-700">{quantityAvailableProducts}</h4>
                                <div className="text-gray-500 font-semibold">Sản phẩm còn hàng</div>
                            </div>
                        </div>
                    </div>

                    <div className={'grid grid-rows-5 grid-cols-3 gap-4 place-items-center mb-4 '}>
                        {/*chart revenue*/}
                        <div
                            className="flex items-center justify-center h-[500px] w-full rounded-2xl shadow-md bg-white dark:bg-gray-800 col-span-3 row-span-5 place-items-center">
                            <LineChart/>
                        </div>
                    ...
                    <div className="gap-4 mb-4 !h-full bg-white rounded-2xl shadow-md pb-6">
                        <h2 className="text-2xl font-semibold py-6 ms-5">Laptops bán chạy</h2>
                        ...
                        <div className="relative overflow-x-auto">
                            <table className="w-full text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" className="px-6 py-3">Giới thiệu</th>
                                    <th scope="col" className="px-6 py-3">Giá</th>
                                    <th scope="col" className="px-6 py-3">Số lượng trong kho</th>
